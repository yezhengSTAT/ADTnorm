...
#' @param bw_smallest_cd3 The smallest bandwidth parameter value for CD3. Recommend 0.5 or 0.8.
#' @param bw_smallest_cd4 The smallest bandwidth parameter value for CD4. Recommend 0.5 or 0.8.
#' @param bw_smallest_cd8 The smallest bandwidth parameter value for CD8. Recommend 0.5 or 0.8.
...
#' @param cd3_index Index for CD3 marker. If the ADT marker is named "CD3", the program can detect the index automatically. If users named CD3 uniquely, please provide the index for CD3 markers in the column name of cell_x_adt.
#' @param cd4_index Index for CD4 marker. If the ADT marker is named "CD4", the program can detect the index automatically. If users named CD4 uniquely, please provide the index for CD4 markers in the column name of cell_x_adt.
#' @param cd8_index Index for CD8 marker. If the ADT marker is named "CD8", the program can detect the index automatically. If users named CD8 uniquely, please provide the index for CD8 markers in the column name of cell_x_adt.
