...
#' @param shoulder_valley Indictor to specify whether a shoulder valley is expected in case of the heavy right tail where the population of cells should be considered as positive population.
...
#' @param min_fc Mimimal fold change between the highest peak density height and candidate valley density height. The default is 20.
