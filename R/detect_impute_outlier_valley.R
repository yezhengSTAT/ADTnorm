...
#' @param scale Scale level to defining outlier. A larger scale value corresponds to more severe outliers.
#' @param method Outlier detection methods, choose from "MAD" (Median Absolute Deviation) or "IQR" (InterQuartile Range). The default is MAD.
